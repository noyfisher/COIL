...
- **Views/** (79 files total: 47 top-level + 15 Components + 11 Dashboard + 6 OnboardingSteps) — SwiftUI views using `@ObservedObject`/`@StateObject`. Navigation via `NavigationStack`
...
- **Services/** (27 files) — Singletons (`static let shared`) for API, persistence, validation, logging
