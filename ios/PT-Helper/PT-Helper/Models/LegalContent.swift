...
enum LegalContent {
    ...
    /// Canonical legal-document versions. Bump when the corresponding document
    /// text changes in a way that requires re-acceptance.
    static let tosVersion = "2026.07"
    static let privacyPolicyVersion = "2026.07"
    static let healthDataPolicyVersion = "2026.07"
    ...
    **The App will alert you to potential emergency symptoms (red flags), but this detection is not comprehensive and should not replace medical judgment.**
    ...
    // MARK: - Consumer Health Data Privacy Policy (Washington MHMDA)

    static let consumerHealthDataPolicy: String = #"""
