...
enum PDFExportService {
    ...
    private static func drawHeader(plan: RehabPlan, yOffset: CGFloat, context: UIGraphicsPDFRendererContext) -> CGFloat {
        ...
        "PT Helper".draw(at: CGPoint(x: margin, y: y), withAttributes: brandAttrs)
        y += 20
    ...
    private static func drawFooter(context: UIGraphicsPDFRendererContext) {
        ...
        let disclaimer = "Generated by PT Helper. This is for informational purposes only and does not constitute medical advice. Consult your healthcare provider."
